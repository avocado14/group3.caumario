...
void g4obj1animation() {
    for (int i = 0; i < 4; i++) {
        g4obj1animationcache = fmod(g4obj1animationcache, 4);
    ...
    g4obj1animationcache = g4obj1animationcache + 0.7;
}

void g4obj2animation() {
    for (int i = 0; i < 4; i++) {
        g4obj2animationcache = fmod(g4obj2animationcache, 10);
    ...
    g4obj2animationcache = g4obj2animationcache +0.5;
    }

void g4obj3animation() {
    for (int i = 0; i < 4; i++) {
        g4obj3animationcache = fmod(g4obj3animationcache, 7);
    ...
    g4obj3animationcache = g4obj3animationcache + 0.7;
}
...
void g4obstaclemove(ObjectID obstacle,SceneID scene,int movetype,int currentx,int currenty,int objID) {
    ...
    if (movetype == 1) {
        ...
        case(0):
        {
            ...
            locateObject(obstacle, scene, g4obj1x[objID], g4obj1y[objID]);
            break;
        }
        case(1):
        { g4obj1y[objID] = 110;
...
void g4update() {
    ...
    for ( int i= 0; i < 4; i++) {
        g4obstaclemove(g4obj1[i], scene_g4, 1, g4obj1x[i], g4obj1y[i],i);
    }
    g4death();
}
...
void Game4_main() {
    ...
    g4floor2 = g4createObject("image/game4/바닥.png", scene_g4, 0, 0, true);
